...
public class Ex10RetornaNumeroMaiorEMenor {
	...
	public static void main(String[] args) {
		...
		if (num1 <= num2 && num1 <= num3) {
			System.out.println("O primeiro numero foi o menor. Você digitou " + num1 + ".");
		} else if (num2 <= num1 && num2 <= num3) {
			System.out.println("O segundo numero foi o menor. Você digitou " + num2 + ".");
		} else if (num3 <= num1 && num3 <= num2) {
			System.out.println("O terceiro numero foi o menor. Você digitou " + num3 + ".");
		}
	}
}
